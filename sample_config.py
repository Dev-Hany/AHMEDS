...
class Config(object):
    LOGGER = True
    ALIVE_NAME = os.environ.get("ALIVE_NAME", "@D2_RK")
    ...
    UPSTREAM_REPO = os.environ.get("UPSTREAM_REPO", "https://github.com/Dev-Hany/AHMEDS.git")
    AUTONAME = os.environ.get("AUTONAME", "@D2_RK")
    ...
    THUMB_IMAGE = os.environ.get("THUMB_IMAGE", "https://telegra.ph/file/2337ee78d19fb2958f1ec.jpg")
