...
CATLOGO = "https://telegra.ph/file/bd383a33ca3ac9f9acb48.jpg"
...
async def inline_handler(event):  
    ...
    if query_user_id == Config.OWNER_ID or query_user_id in Config.SUDO_USERS:
        ...
        if query.startswith("**DAROKABOT"):
            buttons = [
                (
                    Button.inline("السورس", data="stats"),
                    Button.url("الريبو", "https://github.com/Dev-Hany/ahmed"),
                )
            ]
            ...
            builder = event.builder
            secret = os.path.join("./D2_RK", "secrets.txt")
            try:
        ...
        buttons = [
            (
                Button.url("Source code", "https://github.com/Dev-Hany/ahmed"),
                Button.url(
                    "Deploy",
        ...
        result = types.InputBotInlineResult(
            ...
            url="https://dashboard.heroku.com/new?template=https://github.com/Dev-Hany/ahmed",
            thumb=photo,
            content=photo,
            send_message=types.InputBotInlineMessageMediaAuto(
                reply_markup=markup, message=text, entities=msg_entities
