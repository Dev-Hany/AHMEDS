...
LOGS = logging.getLogger("تليثون دارك \n ")
...
async def startupmessage():
    try:
        if BOTLOG:
            Config.CATUBLOGO = await iqthon.tgbot.send_file(BOTLOG_CHATID, "https://telegra.ph/file/2337ee78d19fb2958f1ec.jpg", caption="**⁂ - تـمّ  اعـادة تشـغيل .\n⁂ - تليثـون دارك ( 8.3 ) .\n\n⁂ - اوامر السورس : ( .الاوامر  ) \n\n⁂ - لمـعرفة كيفية تغير بعض كلايش او صور السـورس  أرسـل  : (  .مساعده  )\n\n⁂ - قناة تليثون دارك : @D2_RK \n\n❕- يتم اعادة التشغيل كل 24 ساعة ⁂**",                buttons=[(Button.url("مطور السورس", "https://t.me/A7_M3"),)],            )
    except Exception as e:
        LOGS.error(e)
        return None
    ...
    try:
        ...
        if inlinestarbot.bot_inline_placeholder:
            ...
            try:
                ...
                await iqthon.JoinChannelRequest('@D2_RK')
...
async def iqchn():
    ...
    try:
        ...
        await iqthon(JoinChannelRequest("@source_dr"))
    except BaseException:
        pass
...
async def verifyLoggerGroup():
    ...
    if BOTLOG:
        ...
        _, groupid = await create_supergroup(            "تخزين تليثون دارك العام", iqthon, Config.TG_BOT_USERNAME, descript  ,  iqphoto1 )
    ...
    if PM_LOGGER_GROUP_ID != -100:
        ...
        _, groupid = await create_supergroup(            "تخزين تليثون دارك الخاص", iqthon, Config.TG_BOT_USERNAME, descript    , iqphoto2  )
