...
async def pyZip(e):
    ...
    password = pass_ if pass_ else "D2_RK"
...
async def iq(event):
    ...
    if type_of_group == "قناه":
        descript = "🝳 ⦙   هذه قناة إختبار أُنشئت بإستعمال تليثون دارك"
    else:
        descript = "🝳 ⦙   هذه المجموعه إختبار أُنشئت بإستعمال تليثون دارك"
