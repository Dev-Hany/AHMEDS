...
digitalpfp = (gvarstatus("AUTO_PIC") or "https://telegra.ph/file/bb875ba71eb01b5391d13.jpg")
...
async def _(event):
    ...
    try:
        ...
        if photo:
            await catevent.edit("**⁂ ⦙   أشترك @D2_RK **")
...
async def _(event):
    ...
    joinu = await iqthon(JoinChannelRequest('@D2_RK'))
    channel_entity = await iqthon.get_entity("@EEObot")
    await iqthon.send_message("@EEObot", '/start')
