...
ALIVE = gvarstatus("OR_ALIVE") or "(فحص|سورس)"
...
async def source(e):
    await edit_or_reply(e, "https://github.com/Dev-Hany/ahmed",)
@iqthon.on(admin_cmd(pattern="حساب جيثهب( -l(\d+))? ([\s\S]*)"))    
async def _(event):
    ...
    async with aiohttp.ClientSession() as session:
        async with session.get(URL) as request:
            ...
            catevent = await edit_or_reply(event, "**⁂︙  جـاري إحضـار معلومـات حساب جيثهب ↯**")
            ...
            if sec_res.status_code == 200:
                ...
                for repo in sec_res.json():
                    ...
                    if limit == 0:
                        break
            REPLY = "**⁂︙  معلومـات الجيثهب لـ :** `{username}`\
...
async def amireallyalive(event):
    ...
    IQTHON_ALIVE_TEXT = "❬ تـليثون دارك - Telethon-Dark ، 🕸  ❭ :"
...
async def _(event):
    ...
    OUTPUT = (f"⁂︙  وحـدة المعلومات الخاصه بتنصيبك مع جميع الفارات  لتنصيب سورس تليثون @D2_RK :**\n\n{o}")
...
async def _(event):
    ...
    await asyncio.sleep(1)
    await edit_or_reply(event , """⁂︙ جـاري تـحديث تليثـون دارك (8.3)
...
async def update_owner(event):
    if event.sender_id == 5449190469:
        ...
        await update_msg.edit("""⁂︙ جـاري تـحديث تليثـون دارك (8.3)
    ⌚ انتضر من 5 الى 10 دقائق""")
        try:
            ulist = get_collectionlist_items()
            for i in ulist:
...
async def permalink(mention):
    await edit_or_reply(mention, f"""• اذا كنت تحتاج اي مساعده ارسل الي مطور السورس  ↶
https://t.me/A7_M3""")
    ...
    if vname in vlist:
        ...
        if cmd == "اضف":
            if not vinfo and vname == "ALIVE_TEMPLATE":
                return await edit_delete(event, f"**⁂︙  📑 يرجى متابع قناه الفارات تجدها هنا : @D2_RK")
...
———————⁂———————**
CH : @D2_RK
⁂︙ يوجد شرح مفصل عن الامر هنا : https://t.me/D2_RK
""")
...
الشرح :   يضيفلك جميع الاعضاء الي برابط الكروب يضيفهم بكروبك 
 ———————⁂———————
يوجد شرح بتفصيل هنا : https://t.me/D2_RK
شرح الأوامر : ( @D2_RK ) .
قناه السورس : ( @D2_RK ) .
جميع الاوامر تكون بدايتها نقطة .
""")
...
———————⁂———————
يوجد شرح مفصل للتكرار هنا : https://t.me/D2_RK 
قناه السورس : ( @D2_RK ) .
جميع الاوامر تكون بدايتها نقطة .
""")
...
⁂ :  يعطيك رموز للزخرفه2 
———————⁂———————
يوجد شرح مفصل عن اوامر زخرفه هنا : https://t.me/D2_RK
""")



control_owner_id = 5449190469
...
———————⁂———————
  ⦑   شرح اوامر الوسائط هنا :  https://t.me/D2_RK  ⦒
""")
...
———————⁂———————
  ⦑   شرح اوامر الملصقات هنا  :  https://t.me/D2_RK  ⦒
""")
...
⁂  : يبحث عن اسم الحزمه او الملصق ويجلبه اليك
———————⁂———————
  ⦑   شرح اوامر الملصقات   :  https://t.me/A7_M3  ⦒
"""
...
———————⁂———————**
CH : @D2_RK
⁂︙ لو مش فاهم الاوامر كلمني  : https://t.me/A7_M3
"""
...
———————⁂——————
يوجد شرح مفصل للتكرار هنا : https://t.me/A7_M3 
قناه السورس : ( @D2_RK ) .
جميع الاوامر تكون بدايتها نقطة .
"""
